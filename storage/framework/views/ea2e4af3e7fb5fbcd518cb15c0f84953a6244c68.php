...
<div class="d-md-flex h-md-100 align-items-center">
    <div class="col-md-5 p-0 bg-white h-md-100 loginarea">
        <div class="d-md-flex align-items-center h-md-100 p-5 justify-content-center" style="padding-bottom: 7em !important;">
            <form class="border rounded p-5" style="min-width: 38%;" role="form" method="POST" action="<?php echo e(route('login')); ?>">
                <?php echo e(csrf_field()); ?>

                <h3 class="mb-4 text-center">
                    <img class="vert-offset-bottom-1" style="max-width: 100%;" src="<?php echo e(asset('img/mainLogoBlackText.png')); ?>"/>
                </h3>
                ...
                <div class="col-md-3 col-xs-12 noLeftPadding">
                    <small class="text-center">
                        <a class="btn btn-link" style="font-size: 10px !important; padding-top: 1em;" href="<?php echo e(route('password.request')); ?>">
