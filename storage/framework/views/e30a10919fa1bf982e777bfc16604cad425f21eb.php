...
<body>
  ...
  <div class="container-fluid background" style="height: 100%;">
    ...
    <div class="row vert-offset-top-6">
      ...
      <div class="col-md-4 vert-offset-top-1 vert-offset-bottom-1" style="background: white;border-radius: 31px;    padding-bottom: 1em; text-align:center;padding-top: 1em;">
        <h5>Thank you for your order! We'll send you a confirmation via Email shortly.</h5>
