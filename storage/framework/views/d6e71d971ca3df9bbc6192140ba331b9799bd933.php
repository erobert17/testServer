      ...
      if(email.length > 5 && email.indexOf('@') != -1){
        ...
        $.ajax({
          ...
          success:function(data) {
            ...
            $('#exampleModalLong #submit').replaceWith('<a href="http://<?php echo e($thisLandingPageRow[0]->storeUrl); ?>"><button type="button" class="btn btn-primary" id="submit">Go To Store</button></a>');
      ...
      <div class="row vert-offset-top-12">
        ...
        <div class="col-md-4" style="">
          ...
          <?php if(isset($thisLandingPageRow[0]->buttonColor)): ?>
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalLong" style="background:#<?php echo e($thisLandingPageRow[0]->buttonColor); ?>; color:white;">
          <?php else: ?>
