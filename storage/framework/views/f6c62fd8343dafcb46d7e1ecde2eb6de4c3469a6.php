...
<head>
    ...
    <script type="text/javascript" src="<?php echo e(asset('js/accounting.min.js')); ?>"></script>
    ...
    <style type="text/css">
    <?php if(file_exists( public_path().'/uploads/users/id/'.$userId.'/backgroundLP1.jpg' )): ?>
      
      .full {
        background: url(<?php echo e(asset('uploads/users/id/'.$userId.'/backgroundLP1.jpg')); ?>) no-repeat center center fixed; 
    ...
    <?php else: ?>
      .full {
        background: url(<?php echo e(asset('uploads/placeholderBG.jpg')); ?>) no-repeat center center fixed; 
        -webkit-background-size: cover;
        -moz-background-size: cover;
        -o-background-size: cover;
        background-size: cover;
...
<body>
    ...
    <div class="container">
       <div class="row vert-offset-bottom-1">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <h1 class="text-center" style="font-size: 23px;"><?php echo e($address); ?></h1>
            </div>
        </div>
        ...
        $(document).ready(function(){
            ...
            <div class="row vert-offset-top-2">
                ...
                <div class="col-md-6">
                  <div class="row">
                    <div class="col-md-12">
                      <?php if($userProfile->avatar_status == 1): ?>
                        <img src="<?php echo e($userProfile->avatar); ?>" class="khula img-responsive center-block" >
                      <?php endif; ?>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                        <p class="text-center font20 fontWhite proxFont"><?php echo e($user->name); ?></p>
                        <p class="text-center font20 fontWhite proxFont"><?php echo e($user->company); ?></p>
                        <p class="text-center font20 fontWhite proxFont"><?php echo e($user->phone); ?></p>
                    </div>
                  </div>
