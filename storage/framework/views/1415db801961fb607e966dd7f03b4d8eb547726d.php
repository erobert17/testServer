                                ...
                                <tbody>
                                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="hidden-xs"><?php echo e($user->allViews); ?></td>
                                            <td class="hidden-xs"><?php echo e($user->userLeads); ?></td>
                                            <td>
                                            ...
                                            <td class="hidden-sm hidden-xs hidden-md">
                                                <?php if($user->subscribed == 1 || $user->subscriptionsTableCount >= 1): ?>
                                                    Subscribed
                                                <?php else: ?>
                                                    Not Subscribed<br>
                                                    
                                                        <a class="btn btn-sm btn-warning btn-block freeYearButton" id="<?php echo e($user->id); ?>" href="#" data-toggle="tooltip" title="Give Free Year">
                                                            <span class="hidden-xs hidden-sm">Give Free Year</span>
                                                        </a>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('.freeYearButton').click(function(){
            ...
            $(this).replaceWith('<i class="far fa-thumbs-up"></i>');
        });
    });
</script>
