    ...
    <div class="container">
        <div class="row vert-offset-bottom-1 vert-offset-top-2">
            <div class="col-md-12 col-sm-12">
                <h1 class="text-center landingPage"><?php echo $lp->title; ?></h1>
                <p class="secondary text-center vert-offset-bottom-1 landingPageSecondary"><?php echo $lp->secondaryTitle; ?></p>
            </div>
        </div>
