          ...
          <div class="panel-body">
            ...
            <?php echo Form::open(array('action' => 'UsersManagementController@store', 'method' => 'POST', 'role' => 'form')); ?>
              ...
              <div class="form-group has-feedback row">
                <label for="users_industries" class="col-md-3 control-label">User Phone</label>
                <div class="col-md-9">
                  <div class="input-group">
                    <?php echo Form::text('phone', NULL, array('id' => 'phone', 'class' => 'form-control', 'placeholder' => trans('123-456-7890'))); ?>

                    <label class="input-group-addon" for="phone"><i class="fa fa-fw fa-phone" aria-hidden="true"></i></label>
                  </div>
              ...
              <div class="form-group has-feedback row">
                <label for="users_industries" class="col-md-3 control-label">User's Industries</label>
                <div class="col-md-9">
                  <div class="input-group">
                    
                    Real Estate
                      <input type="checkbox" name="users_industries1" value="1" checked="true">
                    <br>
                    Ecommerce
                      <input type="checkbox" name="users_industries2" value="1" checked="true">
                  </div>
              ...
              <div class="form-group has-feedback row">
                <label for="users_industries" class="col-md-3 control-label">Starting Subscription</label>
                <div class="col-md-9">
                  <div class="input-group">
                    Free Year Trial
                      <input type="checkbox" id="freeTrial" name="freeTrial" value="1" checked="true">
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="row">
                  <div class="col-md-12">
                    <button type="button" class="btn btn-success" id="insertRandomPassword">Insert Random Password</button>
                  </div>
                </div>
                ...
                <script type="text/javascript">
                  ...
                  $(document).ready(function(){
                    ...
                    $('#insertRandomPassword').click(function(){
                      var randomNumber = randomString(11, '0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ');

                      
                      $('#password').val(randomNumber);
                      $('#password_confirmation').val(randomNumber);
                    });
