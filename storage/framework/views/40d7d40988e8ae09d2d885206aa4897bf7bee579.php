...
<head>
    ...
    <title><?php echo e($product[0]->name); ?> Shopping Cart</title>
...
<script type="text/javascript">
  ...
  @media(max-width:1100px){
    <?php if(file_exists( public_path().'/uploads/users/id/'.$userId.'/'.$background ) && isset($thisLandingPageRow[0]->backgroundColor) !== true): ?>
      ...
      <div class="row vert-offset-top-12">
        ...
        <div class="col-md-4" style="">
          <?php if($thisLandingPageRow[0]->titleShadow == 1): ?>
            <h1 class="titleTextShadow shoppingCartTitle" style="font-weight: 700; font-size:66px; color:#<?php echo e($thisLandingPageRow[0]->titleColor); ?> !important;"><?php echo e($thisLandingPageRow[0]->title); ?></h1>
          <?php else: ?>
            <h1 class="shoppingCartTitle"  style="font-weight: 700; font-size:66px; color:#<?php echo e($thisLandingPageRow[0]->titleColor); ?> !important;"><?php echo e($thisLandingPageRow[0]->title); ?></h1>
          <?php endif; ?>
          ...
          <h4 style="color:#<?php echo e($thisLandingPageRow[0]->titleColor); ?>"><?php echo e($thisLandingPageRow[0]->secondaryTitle); ?></h4>
              <form action="/singleItemCheckoutStepTwo" method="POST">
                ...
                <label style="color:#<?php echo e($thisLandingPageRow[0]->titleColor); ?>;float:left; font-weight:700; font-size:18px;padding-top: 0.5em;">QTY:&nbsp;</label>
              ...
              <!--
                ...
                <?php if(isset($thisLandingPageRow[0]->buttonColor)): ?>
                  <button type="submit" class="btn btn-primary" style="background:#<?php echo e($thisLandingPageRow[0]->buttonColor); ?>; color:white; float:left; font-weight: 700;font-size: 17px;">Checkout
                  </button>
                <?php else: ?>
        ...
        <div class="col-md-4">
          ...
          <?php if(count($productImages) > 1): ?>
            <?php $__currentLoopData = $productImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              ...
              <?php if($lastImgName != $image->imageName): ?>
                
                <?php if($countEverySix == 1): ?>
                  <div class="row"><br>
                <?php endif; ?>

                <div class="col-md-2 vert-offset-bottom-2" style="text-align: center;">
                  
                  <a href="http://www.growyourleads.com/uploads/users/id/<?php echo e($userId); ?>/productImages/<?php echo e($image->imageName); ?>" data-lightbox="productImg">
                    
                    <img class="lp3PropPrevImgProductImg img-responsive centerAlign" src="http://www.growyourleads.com/uploads/users/id/<?php echo e($userId); ?>/productImages/<?php echo e($image->imageName); ?>" />
