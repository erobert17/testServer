                ...
                <div class="bg-success top_cards">
                    ...
                    <div class="col-lg-7 col-7 icon_padd_right">
                        <div class="float-left cards_content">
                            <span class="number_val" id="visitors_count"><?php echo e(count($views)); ?></span><i class="fa fa-long-arrow-up fa-2x"></i>
                            <br>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $leads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lead): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td class=""><?php echo e($lead->date); ?></td>
                                            <td class=""><?php echo e($lead->email); ?></td>
