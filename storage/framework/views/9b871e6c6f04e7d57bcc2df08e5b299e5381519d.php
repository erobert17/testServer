	...
	Dropzone.options.avatarDropzone = {
	  ...
	  init: function() {
	    ...
	    this.on("success", function(file, res) {
	      ...
	      if(<?php echo e($landingPageNumber); ?> === 6 || <?php echo e($landingPageNumber); ?> === '6'){
	      ...
	      $('#newBackground').attr('src', '/uploads/users/id/<?php echo e($user->id); ?>/backgroundLP'+<?php echo e($landingPageNumber); ?>+'.jpg');
