										...
										<form action="/updateCompanyBranding" method="POST">
													...
													<div class="form-group has-feedback row ">
										                ...
										                <div class="col-md-9">
										                  	<div class="input-group">
										                    	<div class="input-group">
										                    	<input id="company" class="form-control" placeholder="Company" name="company" type="text" value="<?php echo e($user->company); ?>">
											...
											<div class="form-group has-feedback row ">
								                ...
								                <div class="col-md-9">
								                  	<div class="input-group">
								                    	<div class="input-group">
									                    	<input id="url" class="form-control" placeholder="CompanyUrl.com" name="websiteUrl" type="text" value="<?php echo e($user->companyUrl); ?>">
									...
									<div class="tab-pane fade edit_account">
										...
										<div class="tab-content">
										    ...
										    <div id="changepw" class="tab-pane fade in active">
												...
												<form method="POST" action="http://growyourleads.com/profile/<?php echo e($user->id); ?>/updateUserPassword" accept-charset="UTF-8" autocomplete="new-password">
									...
									<div class="tab-pane fade edit_settings active in">
										...
										<form method="POST" action="/updateUserBranding" >
								            ...
								            <div class="form-group has-feedback row ">
								                ...
								                <div class="col-md-9">
								                  	<div class="input-group">
								                    	<input id="name" class="form-control" placeholder="Username" name="name" type="text" value="<?php echo e($user->name); ?>">
								            ...
								            <div class="form-group has-feedback row ">
								                ...
								                <div class="col-md-9">
								                  	<div class="input-group">
								                    	<input id="email" class="form-control" placeholder="User Email" name="email" type="text" value="<?php echo e($user->email); ?>">
								            ...
								            <div class="form-group has-feedback row ">
								                ...
								                <div class="col-md-9">
								                  	<div class="input-group">
								                    	<input id="first_name" class="form-control" placeholder="First Name" name="first_name" type="text" value="<?php echo e($user->first_name); ?>">
								            ...
								            <div class="form-group has-feedback row ">
								                ...
								                <div class="col-md-9">
								                  	<div class="input-group margin-bottom-1">
								                    	<input id="last_name" class="form-control" placeholder="Last Name" name="last_name" type="text" value="<?php echo e($user->last_name); ?>">
								          	...
								          	<div class="form-group has-feedback row ">
								                ...
								                <div class="col-md-9">
								                  	<div class="input-group">
								                    	<div class="input-group">
									                    	<input id="phone" class="form-control" placeholder="Phone" name="Phone" type="text" value="<?php echo e($user->phone); ?>">
									...
									<div class="tab-pane fade edit_account">
										...
										<div class="tab-content">
										    ...
										    <div id="changepw" class="tab-pane fade in active">
												...
												<form method="POST" action="http://growyourleads.com/profile/<?php echo e($user->id); ?>/updateUserPassword" accept-charset="UTF-8" autocomplete="new-password"><input name="_method" type="hidden" value="PUT"><input name="_token" type="hidden" value="fLJWuSAWbJbZXqfzBD3wvDbfA1gBDUp4GMlcVDHt">
										    ...
										    <div id="deleteAccount" class="tab-pane fade">
												...
												<div class="row">
													<div class="col-sm-6 col-sm-offset-3 margin-bottom-3 text-center">
														...
														<form method="POST" action="http://growyourleads.com/profile/<?php echo e($user->id); ?>/deleteUserAccount" accept-charset="UTF-8"><input name="_method" type="hidden" value="DELETE"><input name="_token" type="hidden" value="fLJWuSAWbJbZXqfzBD3wvDbfA1gBDUp4GMlcVDHt">
