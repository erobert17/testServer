...
<body <?php if(isset($thisLandingPageRow[0]->backgroundColor)){
  ...
  @media(max-width:1100px){
    ...
    <?php else: ?>
        .background{ 
          background:url(<?php echo e(asset('uploads/placeholderBG4.jpg')); ?>) no-repeat center center fixed; 
          -webkit-background-size: cover;
          -moz-background-size: cover;
          -o-background-size: cover;
          background-size: cover;
...
font-weight: 700; font-size:55px
  ...
  <script type="text/javascript" src="<?php echo e(asset('js/jquery.datetimepicker.full.js')); ?>"></script>
    ...
    <div class="container-fluid background" style="height: 100%;">
      ...
      ?>
      <?php if( strlen($dateString) > 2 ): ?>
        <div class="row vert-offset-bottom-6 vert-offset-top-2">
          <div class="col-md-12">
              <?php if($thisLandingPageRow[0]->titleShadow == 1): ?>
                <h1 class="preCountdownText titleTextShadow" style="color:#<?php echo e($thisLandingPageRow[0]->titleColor); ?> !important;"><?php echo e($thisLandingPageRow[0]->preCountdownText); ?></h1>
                <h1 id="countdownClock" class="countdownText titleTextShadow" style="color:#<?php echo e($thisLandingPageRow[0]->titleColor); ?> !important;"></h1>
              <?php else: ?>
                <h1 class="preCountdownText" style="color:#<?php echo e($thisLandingPageRow[0]->titleColor); ?> !important;"><?php echo e($thisLandingPageRow[0]->preCountdownText); ?></h1>
                <h1 id="countdownClock" class="countdownText" style="color:#<?php echo e($thisLandingPageRow[0]->titleColor); ?> !important;"></h1>
              <?php endif; ?>
          </div>
        </div>
      <?php endif; ?>
      ...
      <div class="row">
        ...
        <div class="col-md-4" style="">
          ...
          <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalLong" style="background:#<?php echo e($thisLandingPageRow[0]->buttonColor); ?> !important; color:white;">
