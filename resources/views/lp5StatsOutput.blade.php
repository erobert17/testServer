...
<a href="/uploads/users/id/<?php echo $user->id; ?>/csvLP5Output.csv">Download Csv</a>
<?php 
...
$path = '/var/www/recoverleads.com/public_html/andrew/public/uploads/users/id/'.$user->id.'/csvLP5Output.csv';
