...
<head>
    ...
    <!-- CUSTOM !!!! -->
    <style type="text/css">
    @if (file_exists( public_path().'/uploads/users/id/'.$userId.'/backgroundLP2.jpg' ))
      
      .full {
        background: url({{asset('uploads/users/id/'.$userId.'/backgroundLP2.jpg')}}) no-repeat center center fixed; 
