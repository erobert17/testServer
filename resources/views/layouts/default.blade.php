    ...
    <div id="top">
        ...
        <nav class="navbar navbar-static-top">
            <div class="container-fluid m-0">
                <a class="navbar-brand float-left text-center" href="/home">
                    <h4 class="text-white"><img src="{{asset('assets/img/GrowYourLeads-adminlogo.png')}}" class="growYourLeadsLogo" alt="logo"></h4>
                </a>
                <div class="menu">
                        ...
                        <div class="user-settings no-bg">
                            <button type="button" class="btn btn-default no-bg micheal_btn" data-toggle="dropdown">
                                @if ((Auth::User()->profile) && Auth::user()->profile->avatar_status == 1)
                                    <!--<img src="{{ Auth::user()->profile->avatar }}" alt="avatar" class="admin_img2 rounded-circle avatar-img">-->
                                @else
                                    <!--<img class="media-object img-thumbnail user-img rounded-circle admin_img3" style="width: 30px;float: left; height: 30px !important; margin-right: 4px;}" src="{{asset('img/default-user.jpg')}}" >-->
                                @endif
                                <strong>{!! Auth::user()->first_name !!}'s Settings</strong>
                                <span class="fa fa-sort-down white_bg"></span>
                            </button>
                            <div class="dropdown-menu admire_admin">

                                <a class="dropdown-item" href="{{ url('/accountSettings') }}"><i class="fa fa-cogs"></i>
                                    Account Settings</a>

                                <a class="dropdown-item" href="{{ url('/subscribe')}}"><i class="fas fa-dollar-sign"></i>
                                    Subscription
                                </a>
    ...
    <div class="wrapper">
        <div id="left">
                <div class="media user-media bg-dark dker">
                    ...
                    <a class="user-link" href="{{ url('/branding') }}">
                        @if ((Auth::User()->profile) && Auth::user()->profile->avatar_status == 1)
                            <img style="max-width:200px;" class="media-object img-thumbnail user-img" alt="User Picture" src="{{ Auth::user()->profile->avatar }}">
                        @else
                            <img class="media-object img-thumbnail user-img admin_img3" src="{{asset('img/default-user.jpg')}}" >
                        @endif
        ...
        @include('layouts/admireLeftMenu')
...
<!-- # right side -->
   ...
   <!--  plugin scripts for admire theme -->
