      ...
      <div class="row vert-offset-top-12">
        ...
        <div class="col-md-4" style="">
          @if($thisLandingPageRow[0]->titleShadow == 1)
            <h1 class="titleTextShadow shoppingCartTitle" style="font-weight: 700; font-size:66px; color:#{{$thisLandingPageRow[0]->titleColor}} !important;">{{$thisLandingPageRow[0]->title}}</h1>
          @else
            <h1 class="shoppingCartTitle"  style="font-weight: 700; font-size:66px; color:#{{$thisLandingPageRow[0]->titleColor}} !important;">{{$thisLandingPageRow[0]->title}}</h1>
          @endif
              ...
              @if($lastImgName != $image->imageName)
                ...
                <div class="col-md-2 vert-offset-bottom-2" style="text-align: center;">
                  ...
                  <a href="http://www.growyourleads.com/uploads/users/id/{{$userId}}/productImages/{{$image->imageName}}" data-lightbox="productImg">
                    ...
                    <img class="lp3PropPrevImgProductImg img-responsive centerAlign" src="http://www.growyourleads.com/uploads/users/id/{{$userId}}/productImages/{{$image->imageName}}" />
