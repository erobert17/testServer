			...
			<div class="col-md-10 col-md-offset-1">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="grayedBackground">
	    					<img src="@if ($user->profile->avatar_status == 1) {{ $user->profile->avatar }} @else {{asset('img/default-user.jpg')}} @endif" alt="{{ $user->name }}" class="user-avatar">

							<dl class="user-info vert-offset-top-2">
