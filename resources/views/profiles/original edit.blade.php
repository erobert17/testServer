								...
								<div class="tab-content">
									...
									<div class="tab-pane fade in active edit_profile">
											...
											<div class="col-sm-12">
												<div id="avatar_container">
													<div class="collapseOne panel-collapse collapse @if($user->profile->avatar_status == 0) in @endif">
														<div class="panel-body">
															<img src="{{asset('img/default-user.jpg')}}" alt="{{ $user->name }}" class="user-avatar">
														</div>
													</div>
										...
										{!! Form::model($user->profile, ['method' => 'PATCH', 'route' => ['profile.update', $user->name],  'class' => 'form-horizontal', 'role' => 'form', 'enctype' => 'multipart/form-data'  ]) !!}
													...
													<div class="row" data-toggle="buttons">
														...
														<div class="col-xs-12 left-btn-container">
															<label class="btn btn-primary @if($user->profile->avatar_status == 1) active @endif btn-block btn-sm" data-toggle="collapse" data-target=".collapseOne.in, .collapseTwo:not(.in)">
																<input type="radio" name="avatar_status" id="option2" autocomplete="off" value="1" @if($user->profile->avatar_status == 1) checked @endif> Use My Image (.Jpg Only)
															</label>
														</div>
													</div>
												</div>
											...
											<div class="displayNone form-group has-feedback {{ $errors->has('theme') ? ' has-error ' : '' }}">
											...
											<div class="displayNone form-group has-feedback {{ $errors->has('location') ? ' has-error ' : '' }}">
											...
											<div class="displayNone form-group has-feedback {{ $errors->has('twitter_username') ? ' has-error ' : '' }}">
											...
											<div class="displayNone margin-bottom-2 form-group has-feedback {{ $errors->has('github_username') ? ' has-error ' : '' }}">
