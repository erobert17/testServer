                                ...
                                <tbody>
                                    @foreach($users as $user)
                                        <tr>
                                            ...
                                            <td class="hidden-xs">{{$user->allViews}}</td>
                                            <td class="hidden-xs">{{$user->userLeads}}</td>
                                            <td>
                                            ...
                                            <td class="hidden-sm hidden-xs hidden-md">
                                                @if($user->subscribed == 1 || $user->subscriptionsTableCount >= 1)
                                                    Subscribed
                                                @else
                                                    Not Subscribed<br>
                                                    
                                                        <a class="btn btn-sm btn-warning btn-block freeYearButton" id="{{$user->id}}" href="#" data-toggle="tooltip" title="Give Free Year">
