                            ...
                            <table class="table table-striped table-condensed data-table">
                                ...
                                <tbody>
                                    @foreach($leads as $lead)
                                        <tr>
                                            <td>{{$lead->name}}</td>
                                            <td class="hidden-xs"><a href="mailto:{{ $user->email }}" title="email {{ $user->email }}">{{ $lead->email }}</a></td>
                                            <td class="hidden-xs">{{$lead->cell}}</td>
                                            
                                            
                                            <td class="hidden-sm hidden-xs hidden-md">{{$lead->date}}</td>
