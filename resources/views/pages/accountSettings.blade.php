			...
			<div class="col-md-10 col-md-offset-1">
				<div class="panel panel-default">
					...
					<div class="row vert-offset-top-2 vert-offset-bottom-2">
						<div class="col-md-2 col-md-offset-3 col-xs-offset-3">
		...
		<div class="row">
			<div class="col-md-10 col-md-offset-1">
				<div class="panel panel-default">
					...
					<div class="row vert-offset-top-2 vert-offset-bottom-2">
						<div class="col-md-2 col-md-offset-3 col-xs-offset-2">
							<h3 class="margin-bottom-1">
								{{ trans('profile.changePwTitle') }}
							</h3>
						</div>
						<div class="col-xs-offset-2">
						<form id="submitChangePassForm" method="POST" action="http://growyourleads.com/profile/102/updateUserPassword" accept-charset="UTF-8" id="passwordChangeForm" autocomplete="new-password"><input name="_method" type="hidden" value="PUT">
