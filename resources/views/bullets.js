              ...
              $.ajax({
                ...
                success:function(data) {
                 ...
                 // $('#editProperty #propertyId').val(data[0]['id']);
                  ...
                  var propImages = $.map(data, function(value, index) {
                      return [value];
                  });
                  alert(propImages.length);
                  if(data != undefined){
                      ...
                      if(data['propertyId'] != null){
                        ...
                        $('#listExistingPhotos').append('\
                          <div class="savedPropPhoto">\
                            <a href="#">\
                              <div id="'+data['propertyId']+'" class="deletePropPhoto numberedCircle boxShadowLeft circleIconLeft">X</div>\
                            </a>\
