    ...
    class WooZoneSpeedOptimizator extends WooZoneBaseInterfaceSync
    {
        ...
        */
        public function __construct()
        {
            ...
            {
                //wp_enqueue_style( $this->the_plugin->alias . '-speed-optimization', $this->module_folder . 'style.css');
            }
        }
...
?>
        ...
        <script type="text/javascript" src="<?php echo $module_folder_sync;?>app.synchronization.js" ></script>
        <script type="text/javascript" src="<?php echo $this->module_folder;?>app.product_optimization.class.js" ></script>
