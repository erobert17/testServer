...
class ETheme_Version_Check {
    ...
    public function activation_page() {
        ?>
            ...
            <?php else: ?>
                ...
                <p class="et-message et-error"><?php esc_html_e('Your product should be activated so you may get the access to all the Xstore demos, auto theme updates and included premium plugins. The instructions below in toggle format must be followed exactly.', 'xstore'); ?></p>
                ...
                <form class="xstore-form" method="post">
                    ...
                    <input class="et-button no-loader" name="xstore-purchase-code" type="submit" value="<?php esc_attr_e( 'Register theme', 'xstore' ); ?>" />
                </form>
    ...
    public function process_form() {
        if( isset( $_POST['xstore-purchase-code'] ) && ! empty( $_POST['xstore-purchase-code'] ) ) {
            ...
            if( $response_code != '200' ) {
                echo  '<p class="et-message et-error">API request call error. Contact your server providers and ask to update OpenSSL system library to the 1.0 version</p>';
                return;
            }
