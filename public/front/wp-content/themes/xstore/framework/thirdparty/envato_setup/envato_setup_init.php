				...
				public function theme_setup_wizard_content($content){
					if($this->is_possible_upgrade()){
						array_unshift_assoc($content,'upgrade',array(
							'title' => __( 'Upgrade', 'xstore' ),
							'description' => __( 'Upgrade Content and Settings', 'xstore' ),
							'pending' => __( 'Pending.', 'xstore' ),
							'installing' => __( 'Installing Updates.', 'xstore' ),
							'success' => __( 'Success.', 'xstore' ),
