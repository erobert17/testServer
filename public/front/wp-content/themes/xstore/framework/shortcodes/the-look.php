...
// ! The look
// **********************************************************************// 
if ( !function_exists('etheme_the_look_shortcode') ) {
  function etheme_the_look_shortcode($atts, $content) {
      ...
      if ( $products->have_posts() ) : ?>
        <div id="et-look-<?php echo esc_attr( $id ); ?>" class="et-look" data-class="<?php echo esc_attr($images_class); ?>">
              ...
              <script>
                jQuery(document).ready(function($){
                  ...
                  function banner_position() {
                    var length = $( '#et-look-<?php echo esc_attr( $id ); ?> .et-isotope-item' ).length;
                    var position = $( '#et-look-<?php echo esc_attr( $id ); ?> .et-isotope-item.et_banner-section' ).data( 'position' );
                    ...
                    $.each( $( '#et-look-<?php echo esc_attr( $id ); ?> .et-isotope-item') , function( e, t ) {
        ...
        'params' => array(
          ...
          array(
            ...
            'value' => array(
              ...
              // esc_html__('Matches same order you passed in via the 'include' parameter.', 'xstore') => 'post__in'
