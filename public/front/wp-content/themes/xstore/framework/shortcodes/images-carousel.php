...
function vc_theme_vc_images_carousel($atts, $content) {
	...
	<div class="swiper-entry <?php echo apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, $css_class, 'vc_images_carousel', $atts ) ?>">
		<div class="swiper-container" id="carousel-<?php echo esc_attr($carousel_id); ?>" data-breakpoints="<?php echo esc_attr($slides_per_view); ?>" data-xs-slides="<?php echo esc_attr($slides_per_view); ?>" data-sm-slides="<?php echo esc_attr($slides_per_view); ?>" data-md-slides="<?php echo esc_attr($slides_per_view); ?>" data-lt-slides="<?php echo esc_js($slides_per_view) ?>" data-slides-per-view="<?php echo esc_attr($slides_per_view); ?>" data-autoplay="<?php echo esc_attr($speed); ?>" data-loop="<?php echo esc_attr($wrap);?>">
			<!-- Wrapper for slides -->
    ...
    <script type="text/javascript">
        jQuery(document).ready(function($) {
            $("#carousel-<?php echo esc_attr($carousel_id); ?> a.magnific").magnificPopup({
		        type:"image",
		        gallery:{
		            enabled:true
		        }
