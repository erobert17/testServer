...
class ETheme_Blog_Shortcodes {
	...
	public function get_grid( $atts = array() ) {
		...
		if ( $et_loop['blog_layout'] == 'timeline' ) {
			$et_loop['columns'] = 1;
		}
		...
		<div class="et-blog">
			...
			while ( $query->have_posts() ) {
				...
				if( $et_loop['blog_layout'] == 'timeline' || $et_loop['blog_layout'] == 'title-left' ) {
	...
	public function get_carousel( $atts = array() ) {
		$args = $this->get_query_args( $atts );
		return etheme_slider( $args, 'post', $atts );
	}
