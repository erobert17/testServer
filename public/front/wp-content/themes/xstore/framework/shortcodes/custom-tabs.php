      ...
      $params_tab = array(
        ...
        'params' => array(
            array(
              'type' => 'textfield',
              'param_name' => 'title',
              'heading' => __( 'Title', 'xstore' ),
              'description' => __( 'Enter section title (Note: you can leave it empty).', 'xstore' ),
            ),
            array(
              'type' => 'attach_image',
            ...
            array(
              ...
              'heading' => __( 'Section ID', 'xstore' ),
              'description' => __( 'Enter section ID (Note: make sure it is unique and valid according to <a href="%s" target="_blank">w3c specification</a>).', 'xstore' ),
            ),
            array(
              'type' => 'textfield',
              'heading' => __( 'Extra class name', 'xstore' ),
