...
if(!function_exists('etheme_theme_styles')) {
    function etheme_theme_styles() {
        if ( !is_admin() ) {
            ...
            if ( etheme_get_option('bold_icons') ) {
            	wp_enqueue_style("et-icons",get_template_directory_uri().'/css/xstore-icons-bold.css');
            } else {
            	wp_enqueue_style("et-icons",get_template_directory_uri().'/css/xstore-icons-light.css');
            }
	        ...
	        if (class_exists('bbPress') && is_bbpress()) {
	        	wp_enqueue_style("forum-style",get_template_directory_uri().'/css/forum.css', array("parent-style"));
	        }
	        if ( class_exists('WC_LikeToDiscounts_Tab') ) {
	        	wp_enqueue_style("like2discount-style",get_template_directory_uri().'/css/like2discount.css', array("parent-style"));
	        }
            ...
            if ( class_exists('Woocommerce') && is_product() ) {
            	...
            	if ( etheme_get_option('thumbs_slider_vertical') || $slider_direction == 'vertical' ) {
            		wp_enqueue_style("etheme-slick",get_template_directory_uri().'/css/slick.css');
            	}
            }
