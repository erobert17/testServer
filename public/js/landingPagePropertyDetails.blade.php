    ...
    <div class="container">
        <div class="row vert-offset-bottom-1 vert-offset-top-2">
            ...
            <div class="col-md-7 col-sm-12">
                    ...
                    <h1 class="fatTitle text-left">{!! $lp->title !!}</h1>

                    <p class="smallFontP text-left vert-offset-bottom-1 landingPageSecondary">{!! $lp->secondaryTitle !!}</p>
            ...
            <div class="col-md-3 col-sm-12 vert-offset-top-3 propertyLocationSearchBox">
              ...
              {!! Form::text('propertyLocation', null, array('placeholder' => '123 Evergreen St, Springfield, MI ', 'class' => 'btn landingPageDropdown')) !!}

              <br><br>
              
              {!!  Form::label('propertyType', 'Property Type', array('class' => 'allCaps')) !!} <br>
              
              <select name="propertyType" class="btn landingPageDropdown dropdown-toggle bootstrap-select">
              ...
              <select name="propertyFeatures" class="btn landingPageDropdown dropdown-toggle bootstrap-select">
                <option value="Any" selected="selected">Any</option>
              ...
              <div class="row">
                <div class="col-md-6">
                  ...
                  <select name="bathrooms" class="btn landingPageDropdown dropdown-toggle bootstrap-select">
                ...
                <div class="col-md-6">
                  ...
                  <select name="bedrooms" class="btn landingPageDropdown dropdown-toggle bootstrap-select">
                    <option value="1+">1+</option>
                    <option value="2+" selected="selected">2+</option>
                    <option value="3+">3+</option>
                    <option value="4+">4+</option>
              ...
              <span id="ex6SliderVal">$100,000 - $1,000,000</span>
              <input id="priceSlider" style="width:100% !important;" type="text" class="span2 slider" value="" data-slider-min="100000" data-slider-max="1000000" data-slider-step="50000" data-slider-value="[100000, 1000000]"/>
